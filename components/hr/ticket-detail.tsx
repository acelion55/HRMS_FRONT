...
export function TicketDetail({ ticket, onUpdate, onDelete }: Props) {
  ...
  return (
    <div className="flex flex-col h-full min-h-0 bg-white">
      {/* Header */}
      <div className="p-4 border-b border-yellow-100 shrink-0">
      ...
      {/* Tabs */}
      <div className="flex border-b border-yellow-100 bg-yellow-50 shrink-0">
      ...
      {/* Tab content */}
      <div className="bg-yellow-50 flex-1 overflow-y-auto min-h-0">
        {activeTab === "comments" ? (
      ...
      {/* Comment input */}
      <div className="p-4 border-t border-yellow-100 bg-white shrink-0">
        {canSeeInternalNotes && (

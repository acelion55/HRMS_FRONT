...
export function TicketList({ tickets, selectedId, onSelect }: Props) {
  ...
  return (
    <div className="flex flex-col h-full min-h-0">
      <div className="p-4 border-b border-yellow-100 space-y-3 shrink-0">
      ...
      <div className="px-4 py-2 flex items-center justify-between bg-yellow-50 border-b border-yellow-100 shrink-0">
